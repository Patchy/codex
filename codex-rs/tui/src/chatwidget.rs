...
impl ChatWidget {
    ...
    /// this arrives alongside `SubAgentActivityKind::Completed` as the signal
    /// that an agent finished working; the app layer calls this next to
    /// `agent_navigation.mark_running`/`mark_stopped`.
